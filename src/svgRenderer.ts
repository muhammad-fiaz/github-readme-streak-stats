...
/**
 * Default card dimensions (matching PHP implementation)
 */
...
/**
 * Fire icon SVG path (matching PHP implementation)
 */
...
/**
 * Generate the complete SVG wrapper with defs (matching PHP implementation)
 */
export function renderSVGWrapper(
	...
	// Animation styles matching PHP implementation
...
/**
 * Generate a text element with theme colors (matching PHP implementation)
 */
...
/**
 * Render fire icon (matching PHP implementation)
 */
...
/**
 * Render ring with mask for fire icon (matching PHP implementation)
 */
...
/**
 * Generate a line/separator element (matching PHP implementation)
 */
